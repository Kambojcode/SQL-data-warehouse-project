...
BEGIN
    ...
    BEGIN TRY
        ...
        *,
        ...
        )t where flag_last = 1; -- select the most recent record per customer, to get rid of nulls or duplicate values in primary key.
        ...
        CASE UPPER(TRIM(prd_line))
             ...
             WHEN 'T' THEN 'Touring'
             Else 'n/a'
        END AS prd_line,  -- Map product line code to discriptive values
        ...
        CASE WHEN sls_sales IS NULL OR sls_sales <=0 OR sls_sales != sls_quantity * ABS(sls_price)
             ...
             ELSE sls_sales    -- handling the missing data and invalid data and driving the data from already existing columns
        END AS sls_sales,
        sls_quantity,
        CASE WHEN sls_price IS NULL OR sls_price <=0 
             THEN sls_sales/ NULLIF(sls_quantity, 0)
             ELSE sls_price    -- handling the missing data and invalid data and driving the data from already existing columns
        END AS sls_price
        ...
        CASE WHEN cid like 'NAS%' THEN SUBSTRING(cid, 4, LEN(cid))
             ELSE cid  -- remove NAS prefic if present
        END cid,
        ...
        CASE WHEN TRIM(cntry)= 'DE' THEN 'Germany'
             ...
             ELSE TRIM(cntry)
        End AS cntry -- normalising and handle missing or blank country codes
